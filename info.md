...
After installation, create a `devices.json` file with your TeleTask device configuration. See the [documentation](https://github.com/Zelenaar/hacs-teletask#configuration) for details.
